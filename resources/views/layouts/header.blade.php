...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <a class="navbar-brand" href="{{route('menu')}}">Rusia</a><button class="btn btn-link btn-sm order-1 order-lg-0"
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">By Roberto Dominguez</div>
                    </div>
                </div>
            </footer>
        </div>
    ...
    {{-- <script src="{{asset(7'template/assets/demo/chart-bar-demo.js')}}"></script> --}}
