...
class TransaccionController extends Controller
{
    ...
    {
        $transacciones = Transaccion::join('Tipo','Tipo.id','Transaccion.id_tipo')->where('Transaccion.id_user',auth()->user()->id)
        ->orderBy('Transaccion.id', 'desc')->select('Transaccion.*','Tipo.nombre')->paginate(20);
